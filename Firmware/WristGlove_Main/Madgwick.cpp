...
void Madgwick::begin(float freq) {
  sampleFreq = freq;
}
...
void Madgwick::update(float gx, float gy, float gz,
  ...
  // Only use accelerometer if valid
  if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
    ...
    // Only use magnetometer if valid
    ...
    hx = mx * q0q0 - _2q0my * q3 + _2q0mz * q2 + mx * q1q1 +
         _2q1mx * q2 + mx * q2q2 + mx * q3q3 + 0;
    hy = _2q0mx * q3 + my * q0q0 - _2q0mz * q1 + _2q1mx * q3 -
         my * q1q1 + my * q2q2 + _2q2q3 * mz - my * q3q3;
    _2bx = sqrt(hx * hx + hy * hy);
    _2bz = -_2q0mx * q2 + _2q0my * q1 + mz * q0q0 + _2q1mx * q3 -
            mz * q1q1 + _2q2q3 * my - mz * q2q2 + mz * q3q3;
    _4bx = 2.0f * _2bx;
    _4bz = 2.0f * _2bz;
